 ...
 *
 * The followings are the available columns in table '{{articles_category}}':
 * @property string $id
...
class ArticlesCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, parent_id, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'art_category' => array(self::BELONGS_TO, 'ArticlesCategory', 'id'),
		);
	}
	 ...
	 * @return ArticlesCategory the static model class
	 */

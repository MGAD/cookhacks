...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'category_id', ArticlesCategory::allCategories()); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'comment_status', array(0=>'Запретить', 1=>'Разрешить')); ?>

	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Категории статей', 'url'=>array('/articlescategory/index')),
				array('label'=>'Рецепты', 'url'=>array('/recipe/index')),
				array('label'=>'Категории рецептов', 'url'=>array('/recipecategory/index')),
				array('label'=>'Продукты', 'url'=>array('/product/index')),
				array('label'=>'Категории продуктов', 'url'=>array('/productcategory/index')),
